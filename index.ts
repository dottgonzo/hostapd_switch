...
let testinternet=require('promise-test-connection');
let netw=require('netw');
let hostapdconf=require("hostapdjs");
let dnsmasqconf=require('dnsmasq-conf');
...
function HAPDSW(options:{interface:string,wpasupplicant_path:string,hostapd:{interface:string,ssid:string}},init){
let interf;
let wpasupplicant_path;
...
HAPDSW.prototype.host=function(e:any){
